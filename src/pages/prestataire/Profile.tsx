// src/pages/prestataire/Profile.tsx
...
const Profile = () => {
  ...
  const fetchProfile = async () => {
    try {
      ...
      if (userData) {
        // Données du prestataire avec informations supplémentaires
        const prestataireData: PrestataireProfile = {
          ...userData,
          description: userData.description || "Expert en services professionnels avec plus de 5 ans d'expérience.",
          site_web: userData.site_web || "",
          facebook: userData.facebook || "",
          instagram: userData.instagram || "",
        };
        setProfile(prestataireData);
        setFormData({
          nom: prestataireData.nom || "",
          prenom: prestataireData.prenom || "",
          ...
          site_web: prestataireData.site_web || "",
          facebook: prestataireData.facebook || "",
          instagram: prestataireData.instagram || "",
        });
      } else if (user) {
        // Utiliser l'utilisateur du contexte
        const prestataireData: PrestataireProfile = {
          ...user,
          description: user.description || "Expert en services professionnels avec plus de 5 ans d'expérience.",
        ...
        // Données mockées pour un prestataire
        const mockProfile: PrestataireProfile = {
          id: 2,
          nom: "Tech",
          prenom: "Alpha",
          ...
          description: "Expert en plomberie, électricité et climatisation avec plus de 10 ans d'expérience. Interventions rapides et professionnelles dans tout Dakar.",
          site_web: "https://alphatech.sn",
          facebook: "alphatech",
          instagram: "alphatech_sn",
        };
          ...
          <div className="profile-info-section">
            ...
            <div className="info-card">
              ...
              <div className="actions-list">
                <button className="action-btn" onClick={() => navigate("/prestataire/services")}>
                  <i className="bi bi-tools"></i>
                  Mes services
                </button>
                <button className="action-btn" onClick={() => navigate("/prestataire/services/ajouter")}>
                  <i className="bi bi-plus-circle"></i>
                  Ajouter un service
                </button>
                <button className="action-btn" onClick={() => navigate("/prestataire/reservations")}>
                  <i className="bi bi-calendar-check"></i>
                  Réservations reçues
                </button>
                <button className="action-btn" onClick={() => navigate("/prestataire/messages")}>
